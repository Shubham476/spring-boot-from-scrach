...
import static com.example.springSecurityApp.entities.enums.Permission.USER_DELETE;
import static com.example.springSecurityApp.entities.enums.Permission.USER_VIEW;
import static com.example.springSecurityApp.entities.enums.Role.ADMIN;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity){
        httpSecurity.
                authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/posts/**").hasAuthority(USER_VIEW.name())
