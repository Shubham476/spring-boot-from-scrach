...
import com.example.springSecurityApp.entities.Session;
import com.example.springSecurityApp.entities.User;
import com.example.springSecurityApp.repository.SessionRepository;
...
public class SessionService {
    ...
    public void generateNewSession(User user, String refreshToken){
        ...
        if(userSession.size()== SESSION_LIMIT){
            userSession.sort(Comparator.comparing(Session::getLastUserAt));
    ...
    public void validateSession(String refreshToken){
        ...
        session.setLastUserAt(LocalDateTime.now());
