...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeDTO> createNewEmployeeFromJPA(@RequestBody @Valid EmployeeDTO inputEmployee){
    ...
    public ResponseEntity<EmployeeDTO> updateEmployeeById(@PathVariable(name = "employeeId") Long Id, @RequestBody @Valid EmployeeDTO employeeDTO){ //here is the change
