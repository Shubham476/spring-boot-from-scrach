...
class JpaTutorialApplicationTests {
	...
	@Test
	void FindByProductInfo(){
		List<ProductInfo> findByProductInfo = productRepository.findAllBy();
		for(ProductInfo p : findByProductInfo){
	...
	@Test
	void getProductInfo(){
		List<ProductDTOInfo> findByProductInfo = productRepository.getProducts();
		for(ProductDTOInfo p : findByProductInfo){
			System.out.println(p);
		}
	}
	...
	@Test
	void findByTitle(){
		List<ProductInfo> findByTitle = productRepository.findByTitle("Apple iPhone 16", ProductInfo.class);
		for(ProductInfo p : findByTitle){
			System.out.println(p);
		}
	}
